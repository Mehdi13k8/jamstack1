...
const NoopComponent = () => {
  ...
  let searchJeans = NoopComponent;

  if (typeof window !== "undefined") {
    searchJeans = () => {
       return (
       <MDBContainer classname="d-md-flex">
                   <div className="overflow-auto position-absolute" style={{ marginLeft: "-300px", maxWidth: "100%", maxHeight: "51%", marginTop: '-250px' }}>
           <InstantSearch searchClient={searchClient} indexName="Jamstack_Gatsby_Jeans">
       <SearchBox />
{(function() {
  if (Theme.theme == 1) {
    return (<CustomHits />);
