...
const NoopComponent = () => {
  ...
  let searchBaskets = NoopComponent;

  if (typeof window !== "undefined") {
    searchBaskets = () => {
       return (
       <MDBContainer classname="d-md-flex">
                   <div className="overflow-auto position-absolute" style={{ marginLeft: "-250px", maxWidth: "100%", maxHeight: "51%", marginTop: '-250px' }}>
           <InstantSearch searchClient={searchClient} indexName="Jamstack_Gatsby_Baskets">
       <SearchBox />
{(function() {
  if (Theme.theme == 1) {
    return (<CustomHits />);
